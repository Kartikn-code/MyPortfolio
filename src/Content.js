...
const Content = () => {
  return (
    ...
    <section className='content container w-100'>
       ...
       <h1 className='container-fluid relative col-* justify-content-center text-center fs-10 fs-sm-1 ' data-aos="zoom-in"><span style={{color:"#1ecb82 "}}>Full Stack Developer</span> and a little bit of <span className='content1'>Everything</span></h1>
