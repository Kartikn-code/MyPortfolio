...
const Aboutme = () => {
  return (
    <section className='aboutme container w-100 h-100vh' data-aos="fade-down">
        ...
        <p style={{color:'black'}}data-aos="fade-up"className='text-center col-sm-12 container-fluid w-100'>I am a <span className='role'>Full Stack Developer </span>who loves building user-friendly web applications. I'm passionate about creating impactful digital experiences with clean, efficient code.</p>
...
<ul className="example-2 container col-12">
  <li className="icon-content">
    <a
      href="https://www.linkedin.com/in/karthikeyan-sankar-422703251/" target='blank'
      aria-label="LinkedIn"
  ...
  <li className="icon-content">
    <a href="https://github.com/Kartikn-code?tab=repositories" target='blank' aria-label="GitHub" data-social="github">
      <div className="filled"></div>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
  ...
  <li className="icon-content">
    <a
      href="https://www.instagram.com/karthiiiiiii_____/" target='blank'
